...
The cypress-cucumber-preprocessor can generate cucumber.json file output as it runs the features files. This is separate from, and in addition to, any mocha reporter configured in cypress.https://github.com/jenkinsci/cucumber-reports-plugin


Output, by default, is written to cypress/cucumber-json, and one file is generated per feature.

 
This behaviour is configurable. Use cosmiconfig to create a configuration for the plugin, see step definition discussion below, 
